 ...
 * 
 * Copy packages that are "ready to use" to destinations only. Not bundle, or minify here.
 * 
 * config.json example:
 ```
    "copyNodePackages": [
...
export const npCopier = class NpCopier {
    ...
    static #doCopy(item, eachFile, fileResultParent) {
        ...
        const destPath = path.resolve(MODULE_DIR, item.destination, (item.rename ?? relativeName));
