...
export default class NtConfig {
    ...
    /**
     * Get `moduleAssetsDir` property value in config.json
     * 
     * @returns {string} Return value of this property.
     */
    static getModuleAssetsDir() {
        return this.getValue('moduleAssetsDir', 'MyRdbModule');
    }// getModuleAssetsDir
