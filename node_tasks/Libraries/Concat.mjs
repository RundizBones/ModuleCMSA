...
export default class Concat extends BasedBundler {
    ...
    async concat(destinationFile) {
        ...
        for (const sourceFile of this.sourceFiles) {
            const sourceFullPath = path.resolve(MODULE_DIR, sourceFile);
     ...
     * 
     * @param {string} destinationPath The destination path. Relative from this RundizBones module's folder.
