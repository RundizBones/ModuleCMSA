...
?>
                        ...
                        <form id="rdbcmsaToolsUrlAliases-list-form" class="rdba-datatables-form">
                            ...
                            <table id="rdbcmsaToolsURLAliasesTable" class="rdbcmsaToolsURLAliasesTable rdba-datatables-js responsive hover" width="100%">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th class="column-checkbox"><input type="checkbox" onclick="RdbaCommon.dataTableCheckboxToggler(jQuery('.rdbcmsaToolsURLAliasesTable'), jQuery(this));"></th>
