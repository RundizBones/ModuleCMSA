...
?>
                        ...
                        <form id="rdbcmsaurlaliases-add-form" class="rd-form horizontal rdba-edit-form" method="post">
                            <?php 
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-wrapper">
                                    ...
                                    <div class="form-description">
                                        <?php printf(d__('rdbcmsa', 'Use the full URL or related URL start from %1$s. Do not begins with slash mark.'), '<samp>' . rtrim($appBasePath, '/') . '/' . '</samp>'); ?>
