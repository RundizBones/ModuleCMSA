                            ...
                            <div class="column col-md-3 rd-block-level-margin-bottom">
                                <h2 class="rdbcmsa-files-columns-header">
                                    ...
                                    <div class="rd-button-group">
                                        <button id="rdbcmsa-files-new-folder" class="rd-button" type="button" title="<?php echo esc_d__('rdbcmsa', 'New folder'); ?>"><i class="fa-solid fa-folder-plus"></i></button>
                                        <button id="rdbcmsa-files-reload-folder" class="rd-button" type="button" title="<?php echo esc_d__('rdbcmsa', 'Reload'); ?>" onclick="RdbCMSAFilesIndexControllerFolders.reloadFolders();"><i class="reload-icon fa-solid fa-rotate"></i></button>
                                    </div>
                                </h2>
                                ...
                                <h2 class="rdbcmsa-files-columns-header">
                                    ...
                                    <a class="rd-button rdbcmsa-scan-unindex-files-button" href="<?php echo $urls['scanUnindexedUrl']; ?>" title="<?php echo esc_d__('rdbcmsa', 'Scan for unindexed files'); ?>">
                                        <span class="rdbcmsa-scan-icon-stack">
                                            ...
                                            <i class="fa-solid fa-magnifying-glass rdbcmsa-scan-icon-search"></i>
                                        </span>
                        ...
                        <script id="rdbcmsa-files-folders-listing" type="x-handlebars-template">
                                ...
                                <li>
                                    ...
                                    <div class="rd-button-group rdbcmsa-files-folder-commands">
                                        <button class="rd-button tiny rdbcmsa-files-rename-folder" data-folderrelpath="{{relatePath}}" data-foldername="{{name}}" title="<?php echo esc_d__('rdbcmsa', 'Rename'); ?>"><i class="fa-solid fa-pen"></i></button>
                                        <button class="rd-button tiny rdbcmsa-files-delete-folder" data-folderrelpath="{{relatePath}}" data-foldername="{{name}}" title="<?php echo esc_d__('rdbcmsa', 'Delete'); ?>"><i class="fa-solid fa-xmark"></i></button>
                                    </div>
                                    {{#if children}}
                                    <ul>
                                        {{> list}}
