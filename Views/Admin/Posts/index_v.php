...
?>
                            ...
                            <table id="postsListItemsTable" class="postsListItemsTable rdba-datatables-js responsive hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo d__('rdbcmsa', 'Categories'); ?></th>
                                        <th><?php echo d__('rdbcmsa', 'Tags'); ?></th>
                        ...
                        <template id="rdba-datatables-row-actions">
                            <div class="row-actions">
                                ...
                                <span class="action"><a class="rdba-listpage-view" href="{{RdbCMSAPostsIndexObject.baseUrl}}/post/{{post_type}}/{{post_id}}"><?php echo d__('rdbcmsa', 'View'); ?></a></span>
                            </div>
                        </template>
                        ...
                        <template id="rdba-datatables-result-controls">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <label>
                                    <?php echo d__('rdbcmsa', 'Category'); ?>
                                    <select id="rdba-filter-tid" name="filter-tid">
                                    </select>
                                </label>
                                <label>
                                ...
                                <label>
                                    <?php echo d__('rdbcmsa', 'Tag'); ?> 
                                    <input id="prog_find_tag" type="text" list="prog_result_tags">
                                    <input id="rdba-filter-tag-tid" type="hidden" name="filter-tag-tid">
                                    <datalist id="prog_result_tags"></datalist>
                                </label>
                                <label>
                                    <?php echo __('Search'); ?>
