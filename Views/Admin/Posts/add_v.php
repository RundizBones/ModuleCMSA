...
?>
                        ...
                        <form id="posts-add-form" class="rd-form horizontal rdba-edit-form" method="post">
                            ...
                            <div id="posts-editing-tabs" class="tabs rd-tabs">
                                <ul class="rd-tabs-nav">
                                    ...
                                    <li><a href="#post-tab-categoriestags"><?php echo esc_d__('rdbcmsa', 'Categories & tags'); ?></a></li>
                                ...
                                <div id="post-tab-content" class="rd-tabs-content active">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="revision_body_summary"><?php echo d__('rdbcmsa', 'Summary'); ?></label>
                                        <div class="control-wrapper">
                                            <textarea id="revision_body_summary" name="revision_body_summary" rows="5" maxlength="2000"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="post-tab-categoriestags" class="rd-tabs-content">
                                    <div id="categories-form-fields">
                                        <div class="form-group">
                                    ...
                                    <div id="tags-form-fields">
                                        <div class="form-group">
                                            <label class="control-label"><?php echo d__('rdbcmsa', 'Tags'); ?></label>
                                            <div class="control-wrapper">
                                                <input id="prog_tags" type="text" name="prog_tags">
                                            </div>
                                        </div>
                                    </div>
                                </div><!--.rd-tabs-content-->
                                        ...
                                        <div class="column col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="control-wrapper">
                                                    ...
                                                    <div class="form-description">
                                                        <?php echo d__('rdbcmsa', 'The name will be use on address of this post. Do not enter special characters.'); ?> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!--.column-->
                                ...
                                <div id="post-tab-revisionhistory" class="rd-tabs-content">
                                    <?php include __DIR__ . DIRECTORY_SEPARATOR . 'revisionHistory_v.php'; ?> 
                                </div><!--.rd-tabs-content-->
                                <?php }// endif; ?>
                            </div><!--.tabs-->
                        ...
                        <template id="rdbcmsa-contents-categories-formfields">
                            {{#if this}}
                                {{#each this}}
                                <div class="each-category" style="margin-left: {{#getMarginLeft this.t_level}}{{/getMarginLeft}}rem;">
                                    <label><input class="prog_categories" type="checkbox" name="prog_categories[]" value="{{this.tid}}"> {{{this.t_name}}}</label>
                                </div>
                                {{/each}}
                            {{else}}
                                <?php echo d__('rdbcmsa', 'There are no category.'); ?>
                            {{/if}}
                        </template>
