...
/**
 * Module assets for tools > Encode/Decode.
 * 
 * This is separate class for easier to manage.
 */
class ModuleAssetsEncodeDecode
{
    ...
    public function getModuleAssets(): array
    {
        ...
        return [
            'js' => [
                // rdbcmsa tools > encode/decode pages
                [
                    'handle' => 'rdbcmsaToolsEncodeDecodeIndexAction',
                    'file' => $publicModuleUrl . '/assets/js/Controllers/Admin/Tools/EncodeDecode/indexAction.js',
                    'dependency' => ['rdta', 'rdbaCommon'],
                ],
                // end rdbcmsa tools > encode/decode pages
            ],
        ];
    }// getModuleAssets
